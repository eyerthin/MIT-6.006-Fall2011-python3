...
#
# Usage: 
#    docdist3-py3.py filename1 filename2
#
# 这是一个计算两个文本文件距离的程序
# 作为他们文本向量间角度（使用弧度制）
#
...
def inner_product(L1, L2):
    ...
    while i<len(L1) and j<len(L2):
        ...
        if L1[i][0] == L2[j][0]:
            ...
            # 单词 L1[i][0] 在 L1 中，但是不在 L2 中
            i += 1
        else:
            # 单词 L2[j][0] 在 L2 中，但是不在 L1 中
            j += 1
    return sum
...
def main():
    if len(sys.argv) !=3:
        print("请使用：docdist3-py3.py filename_1 filename_2")
    else:
